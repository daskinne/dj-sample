...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.is_shared'
        db.add_column(u'roshee_attachment', 'is_shared',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DealMessage.is_shared'
        db.add_column(u'roshee_dealmessage', 'is_shared',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attachment.is_shared'
        db.delete_column(u'roshee_attachment', 'is_shared')

        # Deleting field 'DealMessage.is_shared'
        db.delete_column(u'roshee_dealmessage', 'is_shared')
