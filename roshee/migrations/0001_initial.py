...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'roshee', ['Deal'])

        # Adding model 'DealMessage'
        db.create_table(u'roshee_dealmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'roshee', ['DealMessage'])


    def backwards(self, orm):
        # Deleting model 'Deal'
        db.delete_table(u'roshee_deal')

        # Deleting model 'DealMessage'
        db.delete_table(u'roshee_dealmessage')
