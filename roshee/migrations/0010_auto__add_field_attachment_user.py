...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.user'
        db.add_column(u'roshee_attachment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attachment.user'
        db.delete_column(u'roshee_attachment', 'user_id')
    ...
    models = {
        ...
        u'roshee.dealmessage': {
            ...
            'deal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['roshee.Deal']"}),
            'g': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_buyer': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_private': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_shared': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
